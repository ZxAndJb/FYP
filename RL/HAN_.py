...
if __name__ == '__main__':
    ...
    TrainingIncludes = readris(open("../Week1/1_Training_Included_20878.ris.txt", 'r', encoding="utf-8"))
    TrainingExcludes = readris(open('../Week1/2_Training_Excluded_38635.ris.txt', 'r', encoding="utf-8"))
    TrainingDf = parseData(TrainingIncludes, TrainingExcludes)
    stopwords = pd.read_csv('../Week1/pubmed.stoplist.csv')
